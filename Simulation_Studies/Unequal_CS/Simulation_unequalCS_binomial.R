# Generating correlated binary outcomes with logit link and specified CVs under GLMM for stepped wedge trials with subclusters and fitting GLMM.
...
# define scenarios
scenarios <- read.table("parameters_binomial_uneqCS_power.txt", header=TRUE, sep="")
